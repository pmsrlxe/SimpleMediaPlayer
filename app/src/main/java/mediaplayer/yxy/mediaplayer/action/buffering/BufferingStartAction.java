...
public class BufferingStartAction extends BaseMediaPlayerAction {

    public BufferingStartAction(SimpleMediaPlayer mediaPlayer, MediaPlayerState changeToState) {
