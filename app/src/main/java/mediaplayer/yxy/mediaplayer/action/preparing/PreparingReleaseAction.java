...
public class PreparingReleaseAction extends BaseMediaPlayerAction {

    public PreparingReleaseAction(SimpleMediaPlayer mediaPlayer, MediaPlayerState changeToState) {
