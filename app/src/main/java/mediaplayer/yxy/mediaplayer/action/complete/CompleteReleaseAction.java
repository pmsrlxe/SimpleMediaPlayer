...
public class CompleteReleaseAction extends CompeleteBaseAction {

    public CompleteReleaseAction(SimpleMediaPlayerImpl mediaPlayer, MediaPlayerState changeToState) {
