...
public class CompleteReleaseAction extends BaseMediaPlayerAction {

    public CompleteReleaseAction(SimpleMediaPlayer mediaPlayer, MediaPlayerState changeToState) {
