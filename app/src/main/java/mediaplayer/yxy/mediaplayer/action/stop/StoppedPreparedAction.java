...
public class StoppedPreparedAction extends BaseMediaPlayerAction {

    public StoppedPreparedAction(SimpleMediaPlayer mediaPlayer, MediaPlayerState changeToState) {
