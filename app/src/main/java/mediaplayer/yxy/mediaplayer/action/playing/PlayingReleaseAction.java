...
public class PlayingReleaseAction extends BaseMediaPlayerAction {

    public PlayingReleaseAction(SimpleMediaPlayer mediaPlayer, MediaPlayerState changeToState) {
