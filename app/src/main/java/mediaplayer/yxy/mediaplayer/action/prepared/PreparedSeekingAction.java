...
public class PreparedSeekingAction extends BaseMediaPlayerAction {

    public PreparedSeekingAction(SimpleMediaPlayer mediaPlayer, MediaPlayerState changeToState) {
