...
public class PreparingSeekingAction extends BaseMediaPlayerAction {

    public PreparingSeekingAction(SimpleMediaPlayer mediaPlayer, MediaPlayerState changeToState) {
