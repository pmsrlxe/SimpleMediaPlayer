...
public class CompeleteBaseAction extends BaseMediaPlayerAction {

    public CompeleteBaseAction(SimpleMediaPlayerImpl simpleMediaPlayer, MediaPlayerState changeToState) {
