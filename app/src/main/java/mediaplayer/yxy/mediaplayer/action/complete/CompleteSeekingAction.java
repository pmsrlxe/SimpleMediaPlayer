...
public class CompleteSeekingAction extends BaseMediaPlayerAction {

    public CompleteSeekingAction(SimpleMediaPlayer mediaPlayer, MediaPlayerState changeToState) {
