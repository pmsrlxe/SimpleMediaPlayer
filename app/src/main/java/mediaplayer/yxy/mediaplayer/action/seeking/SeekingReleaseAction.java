...
public class SeekingReleaseAction extends BaseMediaPlayerAction {

    public SeekingReleaseAction(SimpleMediaPlayer mediaPlayer, MediaPlayerState changeToState) {
