...
public class PreparedReleaseAction extends BaseMediaPlayerAction {

    public PreparedReleaseAction(SimpleMediaPlayer mediaPlayer, MediaPlayerState changeToState) {
