...
public class PreparingResetAction extends BaseMediaPlayerAction {

    public PreparingResetAction(SimpleMediaPlayer mediaPlayer, MediaPlayerState changeToState) {
