...
public class TouchPresenter {
    ...
    public TouchPresenter(Context context,
                          View panelToTouch,
        ...
        touchProgressPresenter = new TouchProgressPresenter(progressView);
        touchVolumePresenter = new TouchVolumePresenter(context, touchVolumeView);
    }

    public void bind() {
        touchProgressPresenter.bind(new TouchProgressModel());
