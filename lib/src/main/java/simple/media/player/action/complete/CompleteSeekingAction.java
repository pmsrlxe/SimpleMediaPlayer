...
public class CompleteSeekingAction extends CompeleteBaseAction {

    public CompleteSeekingAction(SimpleMediaPlayerImpl mediaPlayer, MediaPlayerState changeToState) {
