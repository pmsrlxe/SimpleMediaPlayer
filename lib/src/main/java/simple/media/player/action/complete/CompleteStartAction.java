...
public class CompleteStartAction extends CompeleteBaseAction {

    public CompleteStartAction(SimpleMediaPlayerImpl mediaPlayer, MediaPlayerState changeToState) {
